 ...
 * */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers("/static/**").permitAll()//任何人可以访问静态资源
                .anyRequest().hasRole("1")//只有拥有对应角色的人才能访问其他页面
                .and()
                .formLogin()//表单登录
                .loginPage("/login")//自定义登录采用的页面
                .loginProcessingUrl("/dologin")//前端提交过来的dologin  cation进行处理
                .permitAll()
                .defaultSuccessUrl("/a",true)//请求重定向；登录成功跳转指定页面
         ...
         * **/
                ...
                .tokenValiditySeconds(3600);//过期时间为 1小时;
